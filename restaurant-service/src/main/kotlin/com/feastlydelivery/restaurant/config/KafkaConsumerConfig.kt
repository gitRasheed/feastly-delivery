package com.feastlydelivery.restaurant.config
...
class KafkaConsumerConfig(
    ...
    fun consumerFactory(): ConsumerFactory<String, Any> {
        val jsonDeserializer = JsonDeserializer(Any::class.java).apply {
            addTrustedPackages("com.feastlydelivery.restaurant.events", "java.util")
            setUseTypeHeaders(false)
        }

        val configProps = mapOf(
            ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG to bootstrapServers,
            ConsumerConfig.GROUP_ID_CONFIG to "restaurant-service",
